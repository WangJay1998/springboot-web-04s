...
public class Myutils {
    private static String author ="王伟杰";//作者名称
    private static String outputDir ="D:\\springboot\\springboot-web-04\\src\\main\\java";//生成的位置
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/crm?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false";
    private static String username ="root";//数据库用户名
    private static String password ="root";//数据库密码
    //private static String tablePrefix ="sys";//数据库表的前缀，如tbl_user
    private static String [] tables = {"sys_user","sys_role"}; //生成的表
    private static String parentPackage = "com.ktjiaoyu.demo";//顶级包结构
